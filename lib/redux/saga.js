...
function* smartSelect() {
  try {
    ...
    yield put(actions.smartSelectSuccess(data, moduleName));
    // hide loading
...
function* smartSave(action) {
  try {
    ...
    // show loading
    yield put(actions.smartShowLoading());
    const data = yield call(mode === 'add' ? services.smartInsert : services.smartUpdate, moduleName, action.payload);
